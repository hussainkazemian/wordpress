...
<?php
    ...
    $classic_dog_breeder_blog_post_thumb =  get_theme_mod( 'classic_dog_breeder_blog_post_thumb', 1 );

?>

<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="listarticle">
        <?php if ($classic_dog_breeder_blog_post_thumb == 1 ) {?> 
            ...
            <?php if ('post' == get_post_type()) : ?>
                <div class="postmeta">
                    <?php if (get_theme_mod('classic_dog_breeder_metafields_date', true)) : ?>
                        <div class="post-date pe-2">
                            <a href="<?php echo esc_url(get_month_link($classic_dog_breeder_year, $classic_dog_breeder_month)); ?>">
                                <i class="fas fa-calendar-alt pe-2"></i><?php echo esc_html($classic_dog_breeder_post_date); ?>
                    ...
                    <?php if (get_theme_mod('classic_dog_breeder_metafields_comments', true)) : ?>  
                        <div class="post-comment pe-2">
                            <a href="<?php echo esc_url(get_comments_link()); ?>">
                                <i class="fa fa-comment pe-2"></i><?php comments_number(); ?>
                                <span class="screen-reader-text"><?php comments_number(); ?></span>
                            </a>
                        </div>
                    <?php endif; ?>
                    <?php if (get_theme_mod('classic_dog_breeder_metafields_author', true)) : ?>
                        <div class="post-author pe-2">
                            <a href="<?php echo $classic_dog_breeder_author_link; ?>">
                                <i class="fas fa-user pe-2"></i><?php echo esc_html($classic_dog_breeder_author_name); ?>
                    ...
                    <?php if (get_theme_mod('classic_dog_breeder_metafields_time', true)) : ?>
                        <div class="post-time">
                            <a href="#">
                                <i class="fas fa-clock pe-2"></i><?php echo esc_html(get_the_time()); ?>
