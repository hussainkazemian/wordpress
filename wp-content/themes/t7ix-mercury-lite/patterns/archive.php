 ...
 * Slug: t7ix-mercury-lite/archive
 * Categories: query
 * Block Types: core/query
 * Description: A list of posts, 3 column, with featured image, title, terms and post date.
 */
?>
<!-- wp:query {"query":{"perPage":18,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true,"taxQuery":null,"parents":[]},"tagName":"main","enhancedPagination":true,"metadata":{"categories":["posts"],"patternName":"t7ix-mercury-lite/template-query-loop","name":"<?php esc_html_e( 'Query loop', 't7ix-mercury-lite' ) ?>"},"align":"wide","className":"section blog","layout":{"type":"default"}} -->
<main class="wp-block-query alignwide section blog">
    ...
    <div class="wp-block-group section__wrapper">
        ...
        <div class="wp-block-group title">
            <!-- wp:query-title {"type":"archive","style":{"elements":{"link":{"color":{"text":"var:preset|color|black"}}}},"textColor":"black","fontSize":"large"} /-->
            <!-- wp:term-description {"style":{"elements":{"link":{"color":{"text":"var:preset|color|dark-grey"}}}},"textColor":"dark-grey"} /-->
        </div>
        <!-- /wp:group -->
    </div>
    <!-- /wp:group -->
