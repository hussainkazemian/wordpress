...
<main class="wp-block-query alignwide section blog">
    ...
    <div class="wp-block-group section__wrapper">
        ...
        <div class="wp-block-group title">
            <!-- wp:heading {"level":1,"className":"wp-block-heading title-1"} -->
            <h1 class="wp-block-heading title-1"><?php esc_html_e('Blog', 't7ix-mercury-lite') ?></h1>
            <!-- /wp:heading -->
        </div>
        <!-- /wp:group -->
    </div>
